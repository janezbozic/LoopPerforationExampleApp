...
#include "loopperforationlibrary.h"
#include "perforation/LoopInfo.h"
#include <jni.h>
#include <string>
#include <LogDefs.h>
#include <unistd.h>
...
Java_com_diploma_loopperforationlibrary_PerforationHelper_onServiceConnected(
        JNIEnv* env,
jobject /* this */,
jobject binder)
{
...
extern "C" JNIEXPORT void JNICALL
Java_com_diploma_loopperforationlibrary_PerforationHelper_onServiceDisconnected(
        JNIEnv* env,
jobject /* this */)
{
